...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2026 at 07:07 PM
...
INSERT INTO `events` (`id`, `title`, `description`, `committee`, `event_date`, `location`, `status`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'Clean-up Drive', NULL, 'Environment', '2026-06-20', 'Barangay Hall', 'upcoming', NULL, '2026-06-09 14:24:02', '2026-06-09 14:24:02'),
(2, 'Youth Leadership Seminar', NULL, 'Youth Affairs', '2026-06-25', 'Covered Court', 'upcoming', NULL, '2026-06-09 14:24:02', '2026-06-09 14:24:02'),
(3, 'Tree Planting Activity', NULL, 'Environment', '2026-07-05', 'Riverside Area', 'planned', NULL, '2026-06-09 14:24:02', '2026-06-09 14:24:02'),
(4, 'Wash Wash Wash', 'Washing machineeee', 'Health & Sanitation', '2026-06-24', 'House', 'upcoming', NULL, '2026-06-09 16:52:47', '2026-06-09 16:52:47');
...
INSERT INTO `projects` (`id`, `title`, `committee`, `assigned_user_id`, `category`, `description`, `status`, `start_date`, `target_end_date`, `estimated_budget`, `progress_percent`, `archived_at`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'Clean Up Drive', 'Environment', 6, 'Activity', 'Barangay clean-up project', 'ongoing', '2026-06-01', '2026-06-30', 5000.00, 30, NULL, 6, 6, '2026-06-09 14:33:22', '2026-06-09 14:33:22'),
(2, 'Tree Planting Program', 'Environment', 6, 'Project', 'Plant trees in barangay area', 'completed', '2026-05-01', '2026-05-20', 8000.00, 100, NULL, 6, 6, '2026-06-09 14:33:22', '2026-06-09 14:33:22'),
(3, 'Youth Sports League', 'Youth', 6, 'Event', 'Basketball league for youth', 'ongoing', '2026-06-10', '2026-07-10', 12000.00, 40, NULL, 6, 6, '2026-06-09 14:33:22', '2026-06-09 14:33:22'),
(4, 'Health Awareness Drive', 'Health & Sanitation', 6, 'Program', 'Free check-up for residents', 'ongoing', '2026-06-01', '2026-06-30', 5000.00, 40, NULL, 6, 6, '2026-06-09 14:37:37', '2026-06-09 14:37:37'),
(5, 'Clean Water Project', 'Health & Sanitation', 6, 'Project', 'Water testing and cleanup', 'completed', '2026-05-01', '2026-05-20', 8000.00, 100, NULL, 6, 6, '2026-06-09 14:37:37', '2026-06-09 14:37:37');
...
(1, 'admin_captain', 'captain@starosa1.gov.ph', '$2y$10$NxUkh6fsfW6BqjTvz7EQ4u/GQ6dsA17rQ3af5kj.nkBeLCnM0cea.', 'Juan Reyes', NULL, NULL, 'captain', 'active', '2026-06-09 11:53:47', '2026-06-04 13:39:14', '2026-06-09 11:53:47'),
...
(4, 'akaii9158@gmail.com', 'akaii9158@gmail.com', '$2y$10$ej54.QEaEk9vc46SYoAON.EWg2LvFkqeIihdm6o0/SySG5Ax5AIKa', 'Akai Shuichi', '09123456789', 'Purok 2', 'resident', 'active', NULL, '2026-06-07 13:29:51', '2026-06-07 13:30:37'),
...
(6, 'rey', 'rey@gmail.com', '$2y$10$IrUl5tx6eaJxo2CIFJ7mROIt8zlI8lOyVy9SI6tsseVMVBuD7xjMC', 'Rey Mysterio', NULL, NULL, 'kagawad', 'active', '2026-06-09 15:09:21', '2026-06-09 12:09:51', '2026-06-09 15:09:21');
