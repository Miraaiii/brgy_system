...
<head>
  ...
  <title>Resident Dashboard - Barangay Sta. Rosa 1</title>
  ...
  <aside class="resident-sidebar" id="residentSidebar" aria-label="Resident sidebar">
    ...
    <nav class="sidebar-menu" aria-label="Resident menu">
      <div class="sidebar-group">
        <a class="sidebar-link is-active" href="resident_dashboard.php"><i class="fa-solid fa-house"></i><span>Home</span></a>
      </div>

      <div class="sidebar-group">
        <span class="sidebar-section-label">Documents</span>
        <a class="sidebar-link" href="request.php"><i class="fa-solid fa-file-circle-plus"></i><span>Request Document</span></a>
        <a class="sidebar-link" href="track.php"><i class="fa-solid fa-folder-open"></i><span>My Requests</span></a>
        <a class="sidebar-link" href="../verify.php"><i class="fa-solid fa-file-shield"></i><span>Verify Document</span></a>
      </div>

      <div class="sidebar-group">
        <span class="sidebar-section-label">Blotter / Complaints</span>
        <a class="sidebar-link" href="blotter.php"><i class="fa-solid fa-pen-to-square"></i><span>File a Complaint</span></a>
        <a class="sidebar-link" href="my-blotter.php"><i class="fa-solid fa-scale-balanced"></i><span>My Cases</span></a>
      </div>

      <div class="sidebar-group">
        <span class="sidebar-section-label">Barangay Information</span>
        <a class="sidebar-link" href="../announcements.php"><i class="fa-solid fa-bullhorn"></i><span>Announcements</span></a>
        <a class="sidebar-link" href="../services.php"><i class="fa-solid fa-receipt"></i><span>Services &amp; Fees</span></a>
        <a class="sidebar-link" href="../officials.php"><i class="fa-solid fa-users-line"></i><span>Officials Directory</span></a>
        <a class="sidebar-link" href="../contact.php"><i class="fa-solid fa-phone-volume"></i><span>Contact &amp; Hotlines</span></a>
      </div>
  ...
  <div class="resident-shell">
    ...
    <main class="resident-main" id="dashboard">
      <section class="welcome-banner priority-high">
        ...
        <?php if ($is_verified): ?>
          <span class="verified-badge"><i class="fa-solid fa-circle-check"></i> Verified resident</span>
        <?php else: ?>
          <span class="review-badge"><i class="fa-solid fa-clock"></i> Under review</span>
        <?php endif; ?>
      </section>
      ...
      <?php if (!$is_verified): ?>
        <div class="account-alert" role="alert">
          ...
          <span>Your account is under review. You cannot request documents yet.</span>
        </div>
      <?php endif; ?>
      ...
      <section class="stat-grid priority-high" aria-label="Request status summary">
        <a class="status-card status-card--warning" href="#my-requests" data-request-filter="pending">
          <span class="status-card__icon"><i class="fa-solid fa-hourglass-half"></i></span>
        ...
        <a class="status-card status-card--success" href="#my-requests" data-request-filter="ready">
          <span class="status-card__icon"><i class="fa-solid fa-box-archive"></i></span>
          <span class="status-card__body">
        ...
        <a class="status-card status-card--info" href="#my-requests" data-request-filter="all">
          <span class="status-card__icon"><i class="fa-solid fa-layer-group"></i></span>
          <span class="status-card__body">
      ...
      <section class="high-grid priority-high">
        <div class="dashboard-panel quick-panel" id="request-doc">
          <div class="panel-header">
            <div>
              <h2>Quick Actions</h2>
              <p>Start the common resident tasks faster.</p>
            </div>
          </div>
          <div class="quick-actions">
            <a class="quick-action <?= $is_verified ? '' : 'is-disabled' ?>"
               href="<?= $is_verified ? 'request.php' : '#' ?>"
               aria-disabled="<?= $is_verified ? 'false' : 'true' ?>"
               title="<?= $is_verified ? 'Request a document' : 'Your account is under review. You cannot request documents yet.' ?>">
              <i class="fa-solid fa-file-circle-plus"></i>
              <span>Request a document</span>
              <small>Start a barangay clearance, residency, or certificate request.</small>
            </a>
            <a class="quick-action" href="track.php">
              <i class="fa-solid fa-folder-open"></i>
              <span>Track my Requests</span>
              <small>Review submitted requests and status timelines.</small>
            </a>
            <a class="quick-action" href="blotter.php">
              <i class="fa-solid fa-pen-to-square"></i>
              <span>File a Complaint</span>
              <small>Submit a blotter or complaint for barangay review.</small>
            </a>
            <a class="quick-action" href="../announcements.php">
              <i class="fa-solid fa-bullhorn"></i>
              <span>View announcements</span>
              <small>See the latest barangay news and notices.</small>
            </a>
          </div>
        </div>
        ...
        <div class="dashboard-panel requests-panel" id="my-requests">
          <div class="panel-header">
            <div>
              ...
              <p id="requestFilterLabel">Showing latest document requests.</p>
            </div>
              ...
              <tbody id="requestRows">
                <?php if ($recent_requests): ?>
                  <?php foreach ($recent_requests as $request): ?>
                    <tr data-status="<?= e(strtolower($request['status'])) ?>">
                      <td data-label="Reference Number"><code class="ref-code"><?= e($request['reference_no']) ?></code></td>
                      <td data-label="Document Type">
                        <strong><?= e($request['document_name']) ?></strong>
                        <span><?= e($request['purpose']) ?></span>
                      </td>
                      <td data-label="Date Submitted"><?= e(rd_date_long($request['created_at'])) ?></td>
                      <td data-label="Status"><span class="status-badge status-badge--<?= e(rd_status_class($request['status'])) ?>"><?= e(rd_status_label($request['status'])) ?></span></td>
                      <td data-label="Details">
                        <a class="detail-button" href="request-detail.php?id=<?= e((int)$request['id']) ?>">View details</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                <?php else: ?>
        ...
        <div class="dashboard-panel" id="announcements">
          <div class="panel-header">
            <div>
              ...
              <p>Important notices from the barangay office.</p>
            </div>
          </div>
          <div class="announcement-list">
            <?php if ($announcements): ?>
              <?php foreach ($announcements as $announcement): ?>
                <?php $published_at = $announcement['published_at'] ?: $announcement['created_at']; ?>
                <article class="announcement-item">
                  <div class="announcement-meta">
                    <span class="category-badge category-badge--<?= e(rd_category_class($announcement['category'])) ?>"><?= e($announcement['category'] ?: 'General') ?></span>
                    <time datetime="<?= e(date('Y-m-d', strtotime((string)$published_at) ?: time())) ?>" title="<?= e(rd_date_long($published_at)) ?>"><?= e(rd_relative_time($published_at)) ?></time>
                  </div>
                  <h3 title="<?= e($announcement['title']) ?>"><?= e($announcement['title']) ?></h3>
                  <p><?= e(rd_excerpt($announcement['body'], 100)) ?> <a href="../announcements.php">Read more</a></p>
                </article>
              <?php endforeach; ?>
            <?php else: ?>
              <div class="empty-state empty-state--compact">
                ...
                <span>Published barangay announcements will show here.</span>
              </div>
            <?php endif; ?>
          </div>
        </div>

        <div class="dashboard-panel" id="blotter">
          <div class="panel-header">
            <div>
              <h2>My Blotter / Complaint Cases</h2>
              <p>Cases where you are listed as a party.</p>
            </div>
          </div>
          <div class="case-list">
            <?php if ($blotter_cases): ?>
              <?php foreach ($blotter_cases as $case): ?>
                <article class="case-item">
                  <span class="case-icon"><i class="fa-solid fa-scale-balanced"></i></span>
                  <div>
                    <strong><code class="ref-code"><?= e($case['case_number']) ?></code></strong>
                    <span><?= e($case['incident_type']) ?></span>
                    <small>Filed <?= e(rd_date_long($case['created_at'] ?: $case['incident_date'])) ?></small>
                    <em class="case-hearing">Next hearing: <?= e(rd_datetime($case['next_hearing_at'] ?? null)) ?></em>
                  </div>
                  <span class="status-badge status-badge--<?= e(rd_status_class($case['status'])) ?>"><?= e(rd_status_label($case['status'])) ?></span>
                </article>
              <?php endforeach; ?>
            <?php else: ?>
              <div class="empty-state empty-state--compact">
                <i class="fa-solid fa-scale-balanced"></i>
                <strong>No active blotter cases</strong>
                <span>Any case updates connected to your profile will appear here.</span>
              </div>
            <?php endif; ?>
          </div>
        </div>

        <div class="dashboard-panel profile-panel-card" id="profile">
          <div class="panel-header">
            <div>
              <h2>Profile Completeness</h2>
              <p>Keep your resident record ready for requests.</p>
            </div>
            <strong class="profile-percent"><?= e($profile_percent) ?>%</strong>
          </div>
          <div class="progress profile-progress" role="progressbar" aria-label="Profile completeness" aria-valuenow="<?= e($profile_percent) ?>" aria-valuemin="0" aria-valuemax="100">
            <div class="progress-bar" style="width: <?= e($profile_percent) ?>%">
              <span><?= e($profile_percent) ?>% complete</span>
            </div>
          </div>
          <div class="profile-check-columns">
            <div class="profile-check-group">
              <h3>Completed Items</h3>
              <ul class="profile-check-list">
                <?php foreach ($completed_display_items as $item): ?>
                  <li class="is-complete"><i class="fa-solid fa-circle-check" aria-hidden="true"></i><span><?= e($item) ?></span></li>
                <?php endforeach; ?>
              </ul>
            </div>
            <div class="profile-check-group">
              <h3>Missing Items</h3>
              <?php if ($missing_display_items): ?>
                <ul class="profile-check-list">
                  <?php foreach ($missing_display_items as $item): ?>
                    <li class="is-missing"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i><span><?= e($item) ?></span></li>
                  <?php endforeach; ?>
                </ul>
              <?php else: ?>
                <p class="complete-copy"><i class="fa-solid fa-circle-check"></i> Your required resident details are complete.</p>
              <?php endif; ?>
            </div>
          </div>
          <a class="profile-cta" href="profile.php"><i class="fa-solid fa-user-pen" aria-hidden="true"></i> Complete profile</a>
        </div>
      </section>
