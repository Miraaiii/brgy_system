  ...
  <div class="sidebar-footer">
    <div class="sidebar-user">
      ...
      <div class="user-info">
        ...
        <span class="user-role">Barangay Captain</span>
      </div>
  ...
  <header class="top-navbar" id="topNavbar">
    <div class="navbar-left">
      ...
      <div class="search-wrapper d-none d-md-flex">
        ...
        <input type="text" class="search-input" placeholder="Search residents, documents, cases..."/>
    ...
    <div class="navbar-right">
      ...
      <div class="admin-profile" id="adminProfile">
        ...
        <div class="admin-info d-none d-md-block">
          <span class="admin-name">Juan Reyes</span>
          <span class="admin-role">Captain</span>
        </div>
        <i class="fa-solid fa-chevron-down admin-chevron d-none d-md-block"></i>
        <!-- Profile Dropdown -->
        <div class="profile-dropdown" id="profileDropdown">
          <div class="dropdown-header">
            <div class="dh-avatar">JR</div>
            <div>
              <div class="dh-name">Juan Reyes</div>
              <div class="dh-email">captain@bgystaros1.gov.ph</div>
            </div>
          </div>
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item-custom text-danger"><i class="fa-solid fa-right-from-bracket"></i> Sign Out</a>
        </div>
      </div>
    </div>
  </header>
  ...
  <main class="main-content">
    ...
    <section class="content-section active" id="section-dashboard">
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Welcome back, Kapitan Juan. Here's what's happening today.</p>
        </div>
        <div class="page-actions">
          <button class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-rotate me-1"></i>Refresh</button>
          <button class="btn btn-primary btn-sm"><i class="fa-solid fa-download me-1"></i>Export Report</button>
        </div>
      </div>
      ...
      <div class="row g-4 mb-4">
        <div class="col-6 col-xl-3">
          <div class="stat-card stat-blue">
            ...
            <div class="stat-body">
              <div class="stat-value" data-count="4821">0</div>
        ...
        <div class="col-6 col-xl-3">
          <div class="stat-card stat-green">
            ...
            <div class="stat-body">
              <div class="stat-value">₱<span data-count="84250">0</span></div>
        ...
        <div class="col-lg-4">
          <div class="activity-card h-100">
            <div class="chart-header">
              ...
              <a href="#" class="btn btn-xs btn-outline-primary">View all</a>
            </div>
    ...
    <section class="content-section" id="section-residents">
      <div class="page-header">
        ...
        <div class="page-actions">
          <button class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-file-excel me-1"></i>Export Excel</button>
          <button class="btn btn-outline-danger btn-sm"><i class="fa-solid fa-file-pdf me-1"></i>Export PDF</button>
      ...
      <div class="filter-bar mb-4">
        <div class="row g-2 align-items-center">
          ...
          <div class="col-md-3">
            <button class="btn btn-sm btn-secondary w-100" onclick="resetFilters()"><i class="fa-solid fa-filter-circle-xmark me-1"></i>Reset Filters</button>
          </div>
        </div>
      </div>
      ...
      <ul class="nav nav-tabs doc-tabs mb-4" id="docTabs">
        <li class="nav-item">
          <a class="nav-link active" data-bs-toggle="tab" href="#tabPending">
            Pending <span class="badge bg-warning text-dark ms-1">7</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="tab" href="#tabApproved">
            Approved <span class="badge bg-success ms-1">24</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="tab" href="#tabRejected">
            Rejected <span class="badge bg-danger ms-1">3</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <section class="content-section" id="section-blotter">
      <div class="page-header">
        ...
        <div class="page-actions">
          ...
          <button class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-print me-1"></i>Print Report</button>
        </div>
      </div>
    ...
    <section class="content-section" id="section-financial">
      <div class="page-header">
        ...
        <div class="page-actions">
          <button class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-file-excel me-1"></i>Export</button>
      ...
      <div class="row g-4 mb-4">
        ...
        <div class="col-lg-7">
          <div class="chart-card">
            ...
            <canvas id="incomeExpChart" height="160"></canvas>
          </div>
        </div>
      </div>
    ...
    <section class="content-section" id="section-projects">
      ...
      <!-- Committee Filter -->
      <div class="committee-filter mb-4">
          ...
          <div class="settings-card">
            ...
            <div class="settings-card-body">
              <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm" value="Barangay Sta. Rosa 1"/>
              </div>
              <div class="mb-3">
                <label class="form-label">Municipality</label>
                <input type="text" class="form-control form-control-sm" value="Sta. Rosa, Laguna"/>
              </div>
              <div class="mb-3">
                <label class="form-label">Barangay Captain</label>
                <input type="text" class="form-control form-control-sm" value="Hon. Juan A. Reyes"/>
              </div>
              <div class="mb-3">
                <label class="form-label">Contact Number</label>
                <input type="text" class="form-control form-control-sm" value="+63 949 123 4567"/>
              </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row g-3">
          <div class="col-md-4"><label class="form-label">First Name</label><input type="text" class="form-control" placeholder="e.g. Maria"/></div>
          <div class="col-md-4"><label class="form-label">Middle Name</label><input type="text" class="form-control" placeholder="e.g. Santos"/></div>
          <div class="col-md-4"><label class="form-label">Last Name</label><input type="text" class="form-control" placeholder="e.g. Dela Cruz"/></div>
          <div class="col-md-3"><label class="form-label">Birthdate</label><input type="date" class="form-control"/></div>
          ...
          <div class="col-md-3"><label class="form-label">Civil Status</label>
            <select class="form-select"><option>Single</option><option>Married</option><option>Widowed</option><option>Separated</option></select>
          </div>
          <div class="col-md-3"><label class="form-label">Voter Status</label>
            <select class="form-select"><option>Registered Voter</option><option>Non-Voter</option></select>
          </div>
          <div class="col-md-6"><label class="form-label">Address</label><input type="text" class="form-control" placeholder="House No. & Street"/></div>
          ...
          <div class="col-md-6"><label class="form-label">Contact Number</label><input type="text" class="form-control" placeholder="+63 9XX XXX XXXX"/></div>
          <div class="col-md-6"><label class="form-label">Email Address</label><input type="email" class="form-control" placeholder="Optional"/></div>
        </div>
      </div>
      <div class="modal-footer">
        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button class="btn btn-primary"><i class="fa-solid fa-save me-1"></i>Save Resident</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="newDocRequestModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3"><label class="form-label">Resident Name</label><input type="text" class="form-control" placeholder="Search resident..."/></div>
        ...
        <div class="mb-3"><label class="form-label">Purpose</label><input type="text" class="form-control" placeholder="e.g. Employment, Scholarship, etc."/></div>
        <div class="mb-3"><label class="form-label">Fee</label><input type="number" class="form-control" value="50"/></div>
        <div class="mb-3"><label class="form-label">Remarks</label><textarea class="form-control" rows="2"></textarea></div>
      </div>
      <div class="modal-footer">
        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button class="btn btn-primary"><i class="fa-solid fa-paper-plane me-1"></i>Submit Request</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="newBlotterModal" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row g-3">
          <div class="col-md-6"><label class="form-label">Complainant Name</label><input type="text" class="form-control" placeholder="Full name"/></div>
          <div class="col-md-6"><label class="form-label">Respondent Name</label><input type="text" class="form-control" placeholder="Full name"/></div>
          ...
          <div class="col-md-3"><label class="form-label">Incident Date</label><input type="date" class="form-control"/></div>
          <div class="col-md-3"><label class="form-label">Priority</label>
            <select class="form-select"><option>Normal</option><option>High</option><option>Urgent</option></select>
          </div>
          <div class="col-12"><label class="form-label">Incident Narrative</label><textarea class="form-control" rows="4" placeholder="Describe the incident in detail..."></textarea></div>
          <div class="col-md-6"><label class="form-label">Initial Hearing Date</label><input type="date" class="form-control"/></div>
          <div class="col-md-6"><label class="form-label">Assigned Officer</label>
            <select class="form-select"><option>Kgd. Santos</option><option>Kgd. Mendoza</option><option>Kgd. Torres</option></select>
          </div>
        </div>
      </div>
      <div class="modal-footer">
        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button class="btn btn-danger"><i class="fa-solid fa-gavel me-1"></i>File Blotter</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3"><label class="form-label">Transaction Type</label>
          <select class="form-select"><option>Income</option><option>Expense</option></select>
        </div>
        ...
        <div class="mb-3"><label class="form-label">Description</label><input type="text" class="form-control"/></div>
        <div class="mb-3"><label class="form-label">Amount (₱)</label><input type="number" class="form-control" min="0"/></div>
        <div class="mb-3"><label class="form-label">Date</label><input type="date" class="form-control"/></div>
        <div class="mb-3"><label class="form-label">OR / Reference Number</label><input type="text" class="form-control"/></div>
      </div>
      <div class="modal-footer">
        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button class="btn btn-success"><i class="fa-solid fa-save me-1"></i>Save Transaction</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="addProjectModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3"><label class="form-label">Project Title</label><input type="text" class="form-control"/></div>
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6"><label class="form-label">Start Date</label><input type="date" class="form-control"/></div>
          <div class="col-md-6"><label class="form-label">End Date</label><input type="date" class="form-control"/></div>
        </div>
        <div class="mb-3"><label class="form-label">Budget Allocation (₱)</label><input type="number" class="form-control"/></div>
        <div class="mb-3"><label class="form-label">Status</label>
          <select class="form-select"><option>Planning</option><option>Ongoing</option><option>Completed</option><option>Delayed</option></select>
        </div>
        <div class="mb-3"><label class="form-label">Description</label><textarea class="form-control" rows="3"></textarea></div>
      </div>
      <div class="modal-footer">
        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button class="btn btn-primary"><i class="fa-solid fa-save me-1"></i>Save Project</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3"><label class="form-label">Username</label><input type="text" class="form-control"/></div>
        <div class="mb-3"><label class="form-label">Email</label><input type="email" class="form-control"/></div>
        <div class="mb-3"><label class="form-label">Role</label>
          <select class="form-select"><option>Captain</option><option>Secretary</option><option>Treasurer</option><option>Kagawad</option></select>
        </div>
        <div class="mb-3"><label class="form-label">Password</label><input type="password" class="form-control"/></div>
      </div>
      <div class="modal-footer">
        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button class="btn btn-primary"><i class="fa-solid fa-save me-1"></i>Create Account</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary"><i class="fa-solid fa-print me-1"></i>Print Document</button>
      </div>
    </div>
  </div>
</div>
